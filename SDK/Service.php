...
class Service extends AbstractSoapClientBase
{
    ...
    /**
     * Method to call the operation originally named GetResellerDetails
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \Upmind\DomainNameApiSdk\SDK\StructType\GetResellerDetails $parameters
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\GetResellerDetailsResponse|bool
     */
    public function GetResellerDetails(\Upmind\DomainNameApiSdk\SDK\StructType\GetResellerDetails $parameters)
    {
        try {
            $this->setResult($resultGetResellerDetails = $this->getSoapClient()->__soapCall('GetResellerDetails', [
                $parameters,
            ], [], [], $this->outputHeaders));
        
            return $resultGetResellerDetails;
        } catch (SoapFault $soapFault) {
            $this->saveLastError(__METHOD__, $soapFault);
