...
class DENIC_CreateAuthInfo1Response extends BaseMethodResponse
{
     ...
     */
    public function __construct(?string $authInfo1ExpirationDate = null, ?string $authCode = null, ?string $domainStatus = null, ?\Upmind\DomainNameApiSdk\SDK\StructType\DENIC_CreateAuthInfo1Response $dENIC_CreateAuthInfo1Result = null)
    {
        $this
    ...
    {
        return $this->DENIC_CreateAuthInfo1Result ?? null;
    }
    /**
