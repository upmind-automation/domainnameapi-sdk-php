...
/**
 * This class stands for RestoreRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:RestoreRequest
 * @subpackage Structs
 */
class RestoreRequest extends BaseMethodRequest
{
    /**
     * The DomainName
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RestoreRequest
     * @uses RestoreRequest::setDomainName()
     * @uses RestoreRequest::setId()
     ...
     * @param string $domainName
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\RestoreRequest
     */
