...
/**
 * This class stands for ModifyChildNameServerRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:ModifyChildNameServerRequest
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ModifyChildNameServerRequest extends BaseMethodRequest
{
    /**
     * The Id
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ModifyChildNameServerRequest
     * @uses ModifyChildNameServerRequest::setId()
     * @uses ModifyChildNameServerRequest::setChildNameServer()
     * @uses ModifyChildNameServerRequest::setIpAddressList()
     * @param int $id
     ...
     * Set Id value
     * @param int $id
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\ModifyChildNameServerRequest
     */
