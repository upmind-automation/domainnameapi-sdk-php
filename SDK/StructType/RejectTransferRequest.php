...
/**
 * This class stands for RejectTransferRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:RejectTransferRequest
 * @subpackage Structs
 */
class RejectTransferRequest extends BaseMethodRequest
{
    /**
     * The DomainName
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RejectTransferRequest
     * @uses RejectTransferRequest::setDomainName()
     * @uses RejectTransferRequest::setId()
     ...
     * @param string $domainName
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\RejectTransferRequest
     */
