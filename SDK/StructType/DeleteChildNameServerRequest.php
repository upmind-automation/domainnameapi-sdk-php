...
/**
 * This class stands for DeleteChildNameServerRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:DeleteChildNameServerRequest
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeleteChildNameServerRequest extends BaseMethodRequest
{
    /**
     * The ChildNameServer
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for DeleteChildNameServerRequest
     * @uses DeleteChildNameServerRequest::setChildNameServer()
     ...
     * @param string $childNameServer
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\DeleteChildNameServerRequest
     */
