...
/**
 * This class stands for GetDetailsRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:GetDetailsRequest
 * @subpackage Structs
 */
class GetDetailsRequest extends BaseMethodRequest
{
    /**
     * The AuthCode
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for GetDetailsRequest
     * @uses GetDetailsRequest::setAuthCode()
     * @uses GetDetailsRequest::setDomainName()
     * @uses GetDetailsRequest::setId()
     ...
     * @param string $authCode
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\GetDetailsRequest
     */
