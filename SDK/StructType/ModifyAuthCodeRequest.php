...
/**
 * This class stands for ModifyAuthCodeRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:ModifyAuthCodeRequest
 * @subpackage Structs
 */
class ModifyAuthCodeRequest extends BaseMethodRequest
{
    /**
     * The AuthCode
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ModifyAuthCodeRequest
     * @uses ModifyAuthCodeRequest::setAuthCode()
     * @uses ModifyAuthCodeRequest::setDomainName()
     * @uses ModifyAuthCodeRequest::setId()
     ...
     * @param string $authCode
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\ModifyAuthCodeRequest
     */
