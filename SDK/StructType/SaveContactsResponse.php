...
class SaveContactsResponse extends BaseMethodResponse
{
     ...
     */
    public function __construct(?\Upmind\DomainNameApiSdk\SDK\StructType\SaveContactsResponse $saveContactsResult = null, ?int $administrativeContactId = null, ?int $billingContactId = null, ?int $registrantContactId = null, ?int $technicalContactId = null)
    {
        $this
