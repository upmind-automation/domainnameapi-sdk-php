...
/**
 * This class stands for CancelTransferRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:CancelTransferRequest
 * @subpackage Structs
 */
class CancelTransferRequest extends BaseMethodRequest
{
    /**
     * The DomainName
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for CancelTransferRequest
     * @uses CancelTransferRequest::setDomainName()
     * @uses CancelTransferRequest::setId()
     ...
     * @param string $domainName
     * @return \Upmind\DomainNameApiSdk\SDK\StructType\CancelTransferRequest
     */
